...
crism_rgb_proj = ENVIRasterSingleLayerMSLDEMCProj(basename_crism_rgb_proj, save_dir);
...
[mstdataseq,~] = get_MASTCAMdata('SOL',475,...
    ...
    'ROVER_NAV_VERSION','localized_interp',...
...
MSTproj = MASTCAMCameraProjectionMSLDEM_v2( ...
    mstdataseq(1).L.DRXX,MSLDEMdata,'Version','v3');
% MSTprojRDRXX.loadCache();
MSTproj.proj_MSLDEM2mastcam('Cache_Ver','v3','Load_cache_ifexist',1, ...
    'force',0,'save_file',1, ...
    'VARARGIN_PROCESS',{'COORDINATE_SYSTEM','IAU_MARS_SPHERE'});
MSTproj.proj_mastcam2MSLDEM('Cache_Ver','v3','Load_cache_ifexist',1,...
    'force',0,'save_file',1, ...
    'VARARGIN_PROCESS',{'COORDINATE_SYSTEM','IAU_MARS_SPHERE'});
MSTproj.msldemc_imFOVmask_eval_13('Cache_Ver','v3','Load_cache_ifexist',1);

MSTproj.getUFOVwMSLDEM('Cache_Ver','v3','lcie',1, ...
    'BORDER_ASSESS_OPT','d','force',false,'COORDINATE_SYSTEM','IAU_MARS_SPHERE',...
    'K_L',30,'K_S',1,'PROC_MODE','L2PBK_LL0DYU_M3');


MSTproj.get_mapper('Cache_Ver','v3','lcie',1,'force',false,...
    'VARARGIN_PROCESS',{'COORDINATE_SYSTEM','IAU_MARS_SPHERE'});
