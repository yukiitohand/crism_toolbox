...
MSTprojDRXX = MASTCAMCameraProjectionMSLDEM_v2( ...
    mstdataseq(1).L.DRXX,MSLDEMdata,'Version','v4');
% MSTprojRDRXX.loadCache();
MSTprojDRXX.proj_MSLDEM2mastcam('Cache_Ver','v4','Load_cache_ifexist',1, ...
    'force',0,'save_file',1, ...
    'VARARGIN_PROCESS',{'COORDINATE_SYSTEM','IAU_MARS_SPHERE'});
MSTprojDRXX.proj_mastcam2MSLDEM('Cache_Ver','v4','Load_cache_ifexist',1,...
    'force',0,'save_file',1, ...
    'VARARGIN_PROCESS',{'COORDINATE_SYSTEM','IAU_MARS_SPHERE'});
MSTprojDRXX.msldemc_imFOVmask_eval_13('Cache_Ver','v4','Load_cache_ifexist',1);

MSTprojDRXX.getUFOVwMSLDEM('Cache_Ver','v4','lcie',1, ...
    'BORDER_ASSESS_OPT','d','force',false,'COORDINATE_SYSTEM','IAU_MARS_SPHERE',...
    'K_L',30,'K_S',1,'PROC_MODE','L2PBK_LL0DYU_M3');


MSTprojDRXX.get_mapper('Cache_Ver','v4','lcie',1,'force',false,...
    'VARARGIN_PROCESS',{'COORDINATE_SYSTEM','IAU_MARS_SPHERE'});

mstdataseq.L.load_AXIX();
mstmsiLAXI1 = mstdataseq.L.MASTCAMMSIConstructor('AXI1');
%%
[crismPFFonMASTCAMObj] = crism_get_PFFonMASTCAM(crismpff,MSTprojDRXX,'cache_ver','v1','lcie',0);
crismdataMSLDEMdataProjObj.PFFonMASTCAM = crismPFFonMASTCAMObj;
crismpff_viewer.add_mastcam(MSTprojDRXX,{mstmsiLAXI1,'name','AXI1'});