/* =====================================================================
 * crism_combine_FOVcell_multiPxl_mex.c
 ...
 * 
 * OUTPUTS:
 * 0 msldemc_imFOVcount  : int8  [msldemc_lines x msldemc_samples]
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    int8_t **msldemc_imFOVcount;
    int16_t **msldemc_imFOVsample, **msldemc_imFOVline;
    
    int8_t *pxlftprnt_xiyi;
    ...
    */
    ...
    msldemc_imFOVcount = set_mxInt8Matrix(plhs[0]);
