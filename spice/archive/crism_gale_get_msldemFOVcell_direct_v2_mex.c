/* =====================================================================
 * crism_gale_get_msldemFOV_direct_v2_mex.c
        ...
        int32_t **crismPxl_srngs, int32_t **crismPxl_lrngs)
{
    ...
    for(xi=0;xi<Ncrism;xi++){
        ...
        // for(c=0;c<sz_c;c++){
        //     for(l=0;l<sz_l;l++){
        //         if(msldemc_imFOVmask[c+soffset][l+loffset]==xi){
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    */
    ...
    plhs[1] = mxCreateNumericMatrix(2,Ncrism,mxINT32_CLASS,mxREAL);
    crismPxl_srngs = set_mxInt32Matrix(plhs[1]);
    plhs[2] = mxCreateNumericMatrix(2,Ncrism,mxINT32_CLASS,mxREAL);
    crismPxl_lrngs = set_mxInt32Matrix(plhs[2]);
