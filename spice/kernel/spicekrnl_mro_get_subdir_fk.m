function [subdir] = spicekrnl_mro_get_subdir_fk(spicekrnl_env_vars,dirpath_opt)
% [subdir] = spicekrnl_mro_get_subdir_fk(spicekrnl_env_vars,dirpath_opt)
%  get sub directory path for SPICE fk kernel.
...
get_subdir_func = str2func(['spicekrnl_mro_get_subdir_fk_' fldsys]);
