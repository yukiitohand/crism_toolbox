function [subdir] = spicekrnl_mro_get_subdir_fk_naifarchive_version_naif(spicekrnl_env_vars,dirpath_opt)
% [subdir] = spicekrnl_mro_get_subdir_fk_naifarchive_version_naif(spicekrnl_env_vars,dirpath_opt)
