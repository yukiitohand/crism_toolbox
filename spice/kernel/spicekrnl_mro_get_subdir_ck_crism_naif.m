function [subdir] = spicekrnl_mro_get_subdir_ck_crism_naif(spicekrnl_env_vars,dirpath_opt)
% [subdir] = spicekrnl_mro_get_subdir_ck_crism_naif(spicekrnl_env_vars,dirpath_opt)
%  get sub directory path for SPICE ck crism kernel when
