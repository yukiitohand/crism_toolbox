...
switch upper(dirpath_opt)
    case 'MRO'
        subdir_local  = joinPath(NAIF_MROSPICE_subdir,'sclk');
        subdir_remote = joinPath(NAIF_MROSPICE_subdir,'sclk');
        dirpath = joinPath(localrootDir,url_local_root,subdir_local);
    case 'PDS'
        subdir_local  = joinPath(NAIF_MROSPICE_pds_subdir,'sclk');
        subdir_remote = joinPath(NAIF_MROSPICE_pds_subdir,'sclk');
        dirpath = joinPath(localrootDir,url_local_root,subdir_local);
    otherwise
