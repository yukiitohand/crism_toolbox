...
switch upper(dirpath_opt)
    case 'MRO'
        subdir_local  = joinPath(crism_env_vars.NAIF_MROSPICE_subdir,'ik');
        subdir_remote = joinPath(crism_env_vars.NAIF_MROSPICE_subdir,'ik');
        dirpath = joinPath(localrootDir,url_local_root,subdir_local);
    case 'PDS'
        subdir_local  = joinPath(crism_env_vars.NAIF_MROSPICE_pds_subdir,'ik');
        subdir_remote = joinPath(crism_env_vars.NAIF_MROSPICE_pds_subdir,'ik');
        dirpath = joinPath(localrootDir,url_local_root,subdir_local);
    otherwise
