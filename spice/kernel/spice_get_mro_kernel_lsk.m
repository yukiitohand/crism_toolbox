...
switch upper(dirpath_opt)
    case 'GENERIC'
        subdir_local  = joinPath(crism_env_vars.NAIF_GENERICSPICE_subdir,'lsk');
        subdir_remote = joinPath(crism_env_vars.NAIF_GENERICSPICE_subdir,'lsk');
        dirpath = joinPath(localrootDir,url_local_root,subdir_local);
    case 'MRO'
        subdir_local  = joinPath(crism_env_vars.NAIF_MROSPICE_subdir,'lsk');
        subdir_remote = joinPath(crism_env_vars.NAIF_MROSPICE_subdir,'lsk');
        dirpath = joinPath(localrootDir,url_local_root,subdir_local);
    case 'PDS'
        subdir_local  = joinPath(crism_env_vars.NAIF_MROSPICE_pds_subdir,'lsk');
        subdir_remote = joinPath(crism_env_vars.NAIF_MROSPICE_pds_subdir,'lsk');
        dirpath = joinPath(localrootDir,url_local_root,subdir_local);
    otherwise
