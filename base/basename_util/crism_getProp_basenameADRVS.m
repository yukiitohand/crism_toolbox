function [prop] = getProp_basenameADRVS(basenameADRVS,varargin)
% [prop] = getProp_basenameADRVS(basenameADRVS)
...
[ prop_ori ] = create_propADRVSbasename();
[basenameptrn] = get_basenameADRVS_fromProp(prop_ori);
