function [cdr_rootsubpath] = get_crism_pds_mro_path_cdr_type1(yyyy_doy)
% [cdr_rootsubpath] = get_crism_pds_mro_path_cdr_type1(yyyy_doy)
%   locate the public pds path for CDR of folder_type==1 depending on 
%   yyyy_doy
% Input parameters
%   yyyy_doy: string, year and doy of the year
% Output parameters
%   cdr_rootsubpath: string, path to the data in yyyy_doy, like
...
[cdr_rootsubpath] = get_crism_pds_mro_path(...
